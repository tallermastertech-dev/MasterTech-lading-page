...
// ── TOYOTA intake air duct / resonator — 17752, 17750
    ...
    const xref: Record<string, any> = {
      ...
      'MS10A7251': { 
        titulo: 'Caja de Transferencia PTU AWD Ford Explorer / Edge OEM MS10A-7251', 
        categoria: 'Inyección & Motor', 
        compatibilidad: 'Ford Explorer 3.5L V6 (2011-2019), Ford Edge 3.5L / 2.0L EcoBoost (2011-2018), Ford Flex 3.5L (2011-2019), Ford Taurus AWD (2011-2019), Lincoln MKX / MKT (2011-2018)', 
        descripcionCorta: 'Unidad de transferencia de potencia (PTU / Transfer Case) original Ford FoMoCo para tracción total AWD con engranajes hipoidales templados y carcasa de aluminio reforzado.', 
        descripcionDetallada: 'Caja de transferencia / Power Transfer Unit (PTU) genuina Ford / FoMoCo ref. MS10A-7251 (cross-ref AT4Z-7251-A / AT4Z-7251-G / AT4Z-7251-D / 703107AT). Distribuye el torque del eje delantero a las ruedas traseras en vehículos Ford AWD. Incluye rodamientos cónicos de alta carga y sellos de vitón para alta temperatura. Fluido recomendado: SAE 75W-140 Sintético GL-5.', 
        specs: [
        ...
        referencias: [
          'MS10A-7251 (Ford OEM)',
          'AT4Z-7251-A (Ford FoMoCo)',
          'AT4Z-7251-G (Ford FoMoCo)',
          'AT4Z-7251-D (Ford FoMoCo)',
          '703107AT (Dorman OE Fix)'
        ]
      },
      'AT4Z7251A': {
        titulo: 'Caja de Transferencia PTU AWD Ford Explorer / Edge OEM AT4Z-7251-A',
        categoria: 'Inyección & Motor',
        compatibilidad: 'Ford Explorer 3.5L V6 (2011-2019), Ford Edge 3.5L / 2.0L EcoBoost (2011-2018), Ford Flex 3.5L y Lincoln MKX (2011-2018)',
        descripcionCorta: 'Unidad de transferencia de potencia (PTU / Transfer Case) original Ford FoMoCo para tracción integral AWD.',
        descripcionDetallada: 'PTU original Ford ref. AT4Z-7251-A / MS10A-7251. Tracción integral para plataformas Ford Explorer y Edge.',
        specs: ['Tipo: PTU Transfer Case AWD', 'Compatibilidad: Ford Explorer, Edge, Flex, Taurus', 'Fluido: 75W-140 Sintético GL-5'],
        precio: '$485.00 USD',
        badge: 'Importación Exclusiva USA',
        referencias: ['AT4Z-7251-A (Ford OEM)', 'MS10A-7251 (Ford)', '703107AT (Dorman)']
      },
    };
    ...
    if (/MS10A[-_\s]?7251/i.test(c) || /AT4Z[-_\s]?7251/i.test(c) || (/7251/i.test(c) && /MS10|AT4Z|FORD/i.test(u))) {
      return xref['MS10A7251'];
    }
    return null;
  };
...
{"titulo":"[Tipo ESPECIFICO de repuesto NO generico con Marca+Modelo+Motorizacion+Anios]","categoria":"[Inyección & Motor | Frenos & Discos | Suspensión & Amortiguadores | Aceites & Lubricantes | Baterías & Electricidad | Filtros & Consumibles | Fluidos & Climatización | Cuidado & Detailing]","compatibilidad":"[Marca Modelo Cilindrada Codigo-Motor Anios — varios vehiculos con punto y coma]","descripcionCorta":"[1-2 oraciones tecnicas con material y beneficio clave]","descripcionDetallada":"[Descripcion tecnica completa con material, dimensiones, especificaciones, temperatura de operacion e intervalo de reemplazo]","specs":["[Material o composicion exacta del repuesto]","[Dimensiones o capacidad principal]","[Parametros electricos o mecanicos clave]","[Intervalo de reemplazo o vida util]","[Norma o numero OEM original equivalente]"],"precio":"[$XX.XX (solo monto numerico con signo $, ej: $45.00)]","referencias":["[Numero OEM original exacto del fabricante]","[Equivalente aftermarket Marca + Numero]","[Otra referencia cruzada importante]"]}`;
    ...
    const normalizeCategory = (rawCat: string): string => {
      ...
      if (cl.includes('bater') || cl.includes('battery') || cl.includes('electri') || cl.includes('alternador') || cl.includes('arranque') || cl.includes('sensor') || cl.includes('tpms') || cl.includes('ecu') || cl.includes('modulo') || cl.includes('pcm')) return 'Baterías & Electricidad';
      if (cl.includes('filtro') || cl.includes('filter') || cl.includes('consumible') || cl.includes('bujia') || cl.includes('spark') || cl.includes('cabina')) return 'Filtros & Consumibles';
      if (cl.includes('fluid') || cl.includes('refriger') || cl.includes('coolant') || cl.includes('termostato') || cl.includes('bomba') || cl.includes('radiador') || cl.includes('climat') || cl.includes('a/a') || cl.includes('gas')) return 'Fluidos & Climatización';
