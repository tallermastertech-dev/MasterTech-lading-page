...
const JEEP_SERVICES = [
  {
    icon: Zap,
    title: "Diagnóstico Electrónico Jeep",
    desc: "Escáner computarizado compatible con todos los modelos Jeep: Grand Cherokee, Wrangler, Compass, Renegade, Cherokee. Lectura de códigos DTC, monitoreo de sensores y reset de sistemas.",
  },
  {
    icon: Wrench,
    title: "Mecánica & Mantenimiento Jeep",
    desc: "Mantenimiento preventivo y correctivo especializado: cambio de aceite Pentastar 3.6L y EcoDiesel, filtros OEM, correas de distribución, bomba de agua y afinación completa.",
  },
  {
    icon: ShieldCheck,
    title: "Frenos & Suspensión Jeep",
    desc: "Sistema de frenos 4x4 adaptado a off-road: pastillas cerámicas, discos ventilados, amortiguadores y alineación de tren delantero. Jeep Wrangler, Grand Cherokee y más.",
  },
  {
    icon: Zap,
    title: "Electricidad & Electrónica Jeep",
    desc: "Diagnóstico y reparación del sistema eléctrico Jeep: BCM (Body Control Module), TCM, ECU, alternadores, sistema de encendido e instalaciones eléctricas generales.",
  },
  {
    icon: Wrench,
    title: "Climatización A/C Jeep",
    desc: "Servicio completo de aire acondicionado para Jeep: carga de gas R134a, lubricación del compresor, detección de fugas y limpieza del evaporador y condensador.",
  },
  {
    icon: ShieldCheck,
    title: "Reprogramación ECU Jeep",
    desc: "Calibración y reprogramación del módulo de control del motor (PCM/ECM) para Jeep. Optimización de mapas de inyección, torque y consumo de combustible.",
  },
];

const JEEP_MODELS = [
  "Jeep Grand Cherokee", "Jeep Wrangler", "Jeep Cherokee",
  "Jeep Compass", "Jeep Renegade", "Jeep Gladiator",
...
export default function Jeep() {
  ...
  useEffect(() => {
    // SEO — meta tags de la página Jeep
    document.title = "Especialista en Jeep en Margarita | Taller MasterTech Porlamar";
    ...
    setMeta("description", "Taller especialista en Jeep en Porlamar, Isla de Margarita. Diagnóstico computarizado, mecánica, frenos, electricidad y mantenimiento para Jeep Grand Cherokee, Wrangler, Compass y más. Llámanos al +58 412 356 5012.");
    setMeta("og:title", "Especialista Jeep Margarita | Taller MasterTech", true);
    setMeta("og:description", "Servicio especializado para Jeep en Porlamar, Margarita. Diagnóstico, mecánica, frenos y electricidad. Grand Cherokee, Wrangler, Compass y todos los modelos.", true);
    ...
    linkCanonical.setAttribute("href", "https://www.tallermastertech.com/jeep");

    // Schema.org para página de servicio Jeep
    const existingSchema = document.getElementById("jeep-schema");
    if (!existingSchema) {
      const script = document.createElement("script");
      script.id = "jeep-schema";
      script.type = "application/ld+json";
      script.textContent = JSON.stringify({
        "@context": "https://schema.org",
        "@type": "Service",
        "@id": "https://www.tallermastertech.com/jeep#service",
        "name": "Servicio Especializado para Jeep en Margarita",
        "description": "Taller mecánico especialista en Jeep en Porlamar, Isla de Margarita. Diagnóstico computarizado, mecánica, frenos, electricidad y mantenimiento para todos los modelos Jeep.",
        "provider": {
        ...
        "serviceType": "Reparación y mantenimiento automotriz Jeep",
        "url": "https://www.tallermastertech.com/jeep",
      });
            ...
            >
              <div className="text-center mb-16">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 text-primary font-bold text-xs uppercase tracking-widest">
                  ...
                  Especialistas en Jeep · Porlamar, Margarita
                </div>
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-display font-black tracking-tighter mb-6 uppercase leading-tight">
                  ...
                  <span className="text-primary italic">EN JEEP</span><br />
                ...
                <p className="text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed">
                  En Taller MasterTech somos especialistas certificados en la marca Jeep. Diagnóstico computarizado, mecánica, electrónica y mantenimiento para todos los modelos. Más de 5 años atendiendo Jeep en Margarita.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                  ...
                  >
                    AGENDAR CITA JEEP <WhatsAppIcon size={20} />
                  </a>
                  <a
                    href="/servicios"
              ...
              <div className="glass-card p-10 mb-16">
                <h2 className="text-3xl font-display font-black tracking-tighter mb-2 text-center">
                  MODELOS <span className="text-primary italic">JEEP</span> QUE ATENDEMOS
                </h2>
                <p className="text-zinc-400 text-center mb-8">Servicio especializado para toda la gama Jeep disponible en Venezuela</p>
                <div className="flex flex-wrap gap-3 justify-center">
                  {JEEP_MODELS.map((model, i) => (
                    <div
                      key={i}
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div className="glass-card p-8 text-center flex flex-col justify-center">
                  <h3 className="text-xl font-black mb-3">¿Tu Jeep tiene una falla?</h3>
